...
import 'package:spotify_clone/presentation/watch_tv/bloc/trailer_cubit.dart';
import 'package:spotify_clone/presentation/watch_tv/bloc/trailer_state.dart';
import 'package:youtube_player_flutter/youtube_player_flutter.dart';

class VideoPlayer extends StatelessWidget {
  const VideoPlayer({super.key, required this.tvId});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => TrailerCubit()..getTvTrailer(tvId),
